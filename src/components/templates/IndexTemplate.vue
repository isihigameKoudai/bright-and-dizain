<template>
  <div>
    ...
    <TheDefaultView id="top" title="Works">
      <LabelSection class="position-title"> Concept </LabelSection>
      ...
      <section class="wrapper area-content mt90">
        <div class="area-content-works">
          <LabelSection class="appear-up"> Creative </LabelSection>
          <LabelNormal class="mt20 appear-up">
      ...
      <section class="wrapper area-content mt90">
        ...
        />
        <div class="area-content-works">
          <LabelSection class="appear-up"> Portrait </LabelSection>
          <LabelNormal class="mt20 appear-up">
      ...
      <section class="wrapper area-content mt90">
        <div class="area-content-works">
          <LabelSection class="appear-up"> Media & Report </LabelSection>
          <LabelNormal class="mt20 appear-up">
      ...
      <section class="wrapper mt100 taC">
        ...
        <LabelNormal class="mt30"> お問い合わせはこちらから </LabelNormal>
      </section>
      ...
      <section class="wrapper area-content vertical-top">
        <div class="area-content-works mt90">
          <LabelSection class="appear-up"> HTML/CSS Coding </LabelSection>
          <ImageBox
            :is-small="true"
        ...
        <div class="area-content-works mt90">
          <LabelSection class="appear-up"> WebApp Develop </LabelSection>
          <ImageBox
            :is-small="true"
            class="mt30 sp-dn appear"
            path="/img/webApp.jpg"
